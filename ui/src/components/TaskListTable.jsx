...
const TaskListTable = ({ tableData }) => {
  ...
  const getPriorityBadgeColor = (priority) => {
    switch (priority) {
      case "High":
        return "bg-red-100 text-red-500 border border-red-100";
      case "Medium":
        return "bg-orange-100 text-orange-500 border border-orange-100";
      case "Low":
        return "bg-green-100 text-green-500 border border-green-100";
      default:
